...
Build a real university engineering project that is visually impressive, technically explainable, and developed through increasing levels of achievement. Recover useful hardware and explore deployment mechanisms, flight measurement, simulation, and aircraft-like descent.
...
| Deployed wingspan | 3–4 ft | Wing area, mass, and flight speed unknown |
| Propulsion section | Fighter-jet-inspired thruster; two smaller aft fins | Engine architecture and fin arrangement unresolved |
| Middle section | Fuel body with two motor-driven wings using gears and axles | Packaging concept; no deployment or aerodynamic validation |
...
At a review, a teammate should be able to point to a component, explain its function, show its evidence, and identify its failure behavior. Visitors should be able to understand the project from the diagram and an inert mechanism demonstration.
