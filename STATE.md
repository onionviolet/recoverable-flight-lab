...
Initial user vision, preliminary requirements, development gates, physical build plan, propulsion trade study, simulation plan, registers, and concept diagram are documented.

The local repository and GitHub copy were verified against the same commit before this update. The [achievement goals](docs/ACHIEVEMENT-GOALS.md) now capture reuse, measured flight replay, wing demonstration, prediction validation, and the user-suggested Mach 1 stretch option. Research and comparisons are qualitative; numerical feasibility has not been analyzed.
